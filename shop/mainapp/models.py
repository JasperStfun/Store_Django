...
class MaxResolutionErrorEx(Exception):
    pass
...
class Smartphone(Product):
    ...
    sd_value = models.CharField(
        max_length=255, null=True, blank=True, verbose_name='Объем встроеной памяти'
        ) 
...
class Cart(models.Model):
    ...
    final_price = models.DecimalField(max_digits=9, default=0, decimal_places=2 ,verbose_name='Сумма к оплате')
...
class Customer(models.Model):
    ...
    adress = models.CharField(max_length=192, verbose_name='Адресс', null=True, blank=True)
...
class Order(models.Model):
    ...
    STATUS_CHOICES = (
        ...
        (STATUS_IN_PROGRESS, 'Заказ обрабатывается'),
